...
func Init() *appx.App {
	...
	syncIMEventProducer := events.NewSyncOpenIMProducer(syncProducer)
	syncSearchEventProducer := events.NewSyncSearchProducer(syncProducer)
	...
	userService := service.NewUserService(syncIMEventProducer, syncSearchEventProducer, userRepository, logger)
