...
// Source: /Users/stone/go_project/ebook/ebook/cmd/internal/repository/cache/article.go
...
func (mr *MockArticleCacheMockRecorder) DelFirstPage(ctx, authorId interface{}) *gomock.Call {
...
func (mr *MockArticleCacheMockRecorder) GetFirstPage(ctx, authorId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockArticleCache) SetFirstPage(ctx context.Context, authorId int64, arts []domain.Article) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetFirstPage", ctx, authorId, arts)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetFirstPage indicates an expected call of SetFirstPage.
func (mr *MockArticleCacheMockRecorder) SetFirstPage(ctx, authorId, arts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetFirstPage", reflect.TypeOf((*MockArticleCache)(nil).SetFirstPage), ctx, authorId, arts)
}
