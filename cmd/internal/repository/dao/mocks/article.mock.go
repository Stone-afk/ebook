...
// Source: /Users/stone/go_project/ebook/ebook/cmd/internal/repository/dao/article/types.go

// Package daomocks is a generated GoMock package.
package daomocks

import (
	article "ebook/cmd/internal/repository/dao/article"
	reflect "reflect"
	time "time"
...
func (m *MockArticleDAO) GetByAuthor(ctx context.Context, authorId int64, offset, limit int) ([]article.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleDAO) ListPubByUtime(ctx context.Context, uTime time.Time, offset, limit int) ([]article.PublishedArticle, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticleReaderDAO) Upsert(ctx context.Context, art article.Article) error {
	m.ctrl.T.Helper()
...
func (m *MockArticleReaderDAO) UpsertV2(ctx context.Context, art article.PublishedArticle) error {
	m.ctrl.T.Helper()
...
func (m *MockArticleAuthorDAO) Create(ctx context.Context, art article.Article) (int64, error) {
	m.ctrl.T.Helper()
...
// UpdateById mocks base method.
func (m *MockArticleAuthorDAO) UpdateById(ctx context.Context, art article.Article) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateById", ctx, art)
	ret0, _ := ret[0].(error)
	return ret0
