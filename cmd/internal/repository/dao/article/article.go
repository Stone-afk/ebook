...
func (dao *GORMArticleDAO) ListPubByUtime(ctx context.Context, uTime time.Time,
...
func (dao *GORMArticleDAO) SyncStatus(ctx context.Context, authorId, id int64, status uint8) error {
