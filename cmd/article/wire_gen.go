...
func Init() *appx.App {
	...
	feedEventProducer := events.NewArticleFeedEventProducer(syncProducer)
	articleService := service.NewArticleService(articleRepository, readEventProducer, syncSearchEventProducer, feedEventProducer, logger)
