...
const (
	SyncService_InputBizTags_FullMethodName = "/search.v1.SyncService/InputBizTags"
...
type SyncServiceClient interface {
	InputBizTags(ctx context.Context, in *InputBizTagsRequest, opts ...grpc.CallOption) (*InputBizTagsResponse, error)
...
func (c *syncServiceClient) InputBizTags(ctx context.Context, in *InputBizTagsRequest, opts ...grpc.CallOption) (*InputBizTagsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InputBizTagsResponse)
	err := c.cc.Invoke(ctx, SyncService_InputBizTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SyncServiceServer interface {
	InputBizTags(context.Context, *InputBizTagsRequest) (*InputBizTagsResponse, error)
...
func (UnimplementedSyncServiceServer) InputBizTags(context.Context, *InputBizTagsRequest) (*InputBizTagsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InputBizTags not implemented")
}
...
func _SyncService_InputBizTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InputBizTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncServiceServer).InputBizTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SyncService_InputBizTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncServiceServer).InputBizTags(ctx, req.(*InputBizTagsRequest))
	}
...
var SyncService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "InputBizTags",
			Handler:    _SyncService_InputBizTags_Handler,
		},
		{
