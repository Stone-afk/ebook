...
// Source: /Users/stone/go_project/ebook/ebook/cmd/reward/service/types.go
...
import (
	context "context"
	domain "ebook/cmd/reward/domain"
	reflect "reflect"
...
func (mr *MockRewardServiceMockRecorder) GetReward(ctx, rid, uid interface{}) *gomock.Call {
...
func (mr *MockRewardServiceMockRecorder) PreReward(ctx, r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRewardServiceMockRecorder) UpdateReward(ctx, bizTradeNO, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
